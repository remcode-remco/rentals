...
const Hero = ({content,scrolledHalfway,doneLoading}:{content?:TextHero,scrolledHalfway:boolean,doneLoading:boolean}) => {
  ...
  return (
    <section className="relative h-screen flex items-center lg:items-end">
      <div className={`fixed top-0 bottom-0 left-0 right-0 ${doneLoading ? "opacity-100 transition-all duration-500" : "opacity-0"}`}>
